...
coordinator_agent = Agent(
    ...
    description="Main coordinator agent that gathers travel preferences and queries sub-agents.",
    instruction=f"""
...
- For the end_date: If the user only provides the number of days, calculate the end_date based on {today} or the provided start_date. If no start_date is provided, ask the user to specify a preferred date or default to today’s date.
